...
namespace OnionMedia.Core.Classes
{
    public static class DownloaderMethods
    {
        ...
        private static async Task<string> DownloadAudioAsync(StreamItemModel stream, ILogger logger, OptionSet ytOptions, CancellationToken cToken = default)
        {
        ...
        private static async Task<string> RunAudioDownloadAndConversionAsync(StreamItemModel stream, ILogger logger, OptionSet ytOptions, bool isShortened = false, TimeSpan overhead = default, CancellationToken cToken = default)
        {
            //Download
        ...
        private static async Task<string> RunVideoDownloadAndConversionAsync(StreamItemModel stream, ILogger logger, OptionSet ytOptions, bool isShortened = false, bool autoConvertToH264 = false, TimeSpan overhead = default, CancellationToken cToken = default)
        {
        ...
        /// </summary>
        /// <returns>The path of the converted file</returns>
        private static async Task<string> ConvertToMp4Async(string inputfile,ILogger logger, TimeSpan startTime = default, TimeSpan endTime = default, StreamItemModel stream = null, Size resolution = default, IMediaAnalysis videoMeta = null, CancellationToken cancellationToken = default)
        {
